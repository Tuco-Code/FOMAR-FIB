...
def jacobian(t,d):
    ...
    j = np.array([[dx1[0][3],dx2[0][3],dx3[0][3],dx4[0][3],dx5[0][3],dx6[0][3],dx7[0][3],dx8[0][3],dx9[0][3]],
                  [dx1[1][3],dx2[1][3],dx3[1][3],dx4[1][3],dx5[1][3],dx6[1][3],dx7[1][3],dx8[1][3],dx9[1][3]] ,
                  [dx1[0][0],dx2[0][0],dx3[0][0],dx4[0][0],dx5[0][0],dx6[0][0],dx7[0][0],dx8[0][0],dx9[0][0]] ])
    return j
...
for frame in range(0,60):
    actual_x = 13 + (8*frame*frame - 21*frame*60 + 7*frame*60) / (60*60) 
    #it goes from x = 13 to x = 7
    next_x = 13 + (8*(frame+1)*(frame+1) - 21*(frame+1)*60 + 7*(frame+1)*60) / (60*60)
    ...
    if frame < 10:
        command = "povray +O./imagesEX4b/0{}frame jcb.pov".format(frame)
    else:
        command = "povray +O./imagesEX4b/{}frame jcb.pov".format(frame)
